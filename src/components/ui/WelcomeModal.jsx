  ...
  return (
    <div className="animate-fade-in pb-12 mt-4">
      <div className="bg-white rounded-3xl shadow-sm border border-slate-200 max-w-4xl mx-auto p-8 md:p-12 relative overflow-hidden">
        ...
        <p className="text-slate-500 text-lg font-medium mb-10 max-w-2xl">This is no ordinary budget tracker. It's a forward-looking wealth engine. You will create isolated <strong>Workspaces</strong> for each year of your life, governed by a simple 3-step philosophy:</p>
        ...
        <div className="space-y-8 mb-12">
          <div className="flex gap-5 items-start">
            ...
            <div>
              ...
              <p className="text-base text-slate-600 mt-1 max-w-xl">Open a new Workspace for the year. Log your exact starting balances—what you own, what you owe, and your expected income.</p>
            </div>
          </div>
          ...
          <div className="flex gap-5 items-start">
            ...
            <div>
              ...
              <p className="text-base text-slate-600 mt-1 max-w-xl">At the end of the year, lock your Workspace. Compare what you intended to do against your actual bank statements, then roll the balances into the next year.</p>
            </div>
          </div>
        </div>
